...
public:
    ...
    int TCPSessionStart(int ProcDescriptor,pid_t processID)
    {
        cout << "\n Session start";
        procDescriptor = ProcDescriptor;
        COUNT = 20;
    ...
    if(serverType == 2)
    {
        ...
        for(;;)
        {
            ...
            if (fork() == 0)
            {
                ...
                while(ses.TCPSessionStart(connfd,childpid) == 0);
                close(connfd);
            }
